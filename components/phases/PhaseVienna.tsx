      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-4">
          ...
          <p className="text-cream-muted text-base leading-relaxed">
            Cultural immersion and logistics. Vienna&apos;s grand boulevards, baroque palaces, and legendary
            coffeehouses set the stage before the mountains begin.
          </p>

          <div className="bg-dark-card border border-amber/20 rounded-lg p-4">
            <div className="text-sm text-amber tracking-widest uppercase mb-2 font-medium">⚠️ Critical: Naschmarkt</div>
            <p className="text-cream-muted text-base leading-relaxed">
              Visit <strong className="text-cream">Saturday Sept 5 only</strong> — buy nuts, dried fruits, and alpine
              cheese for the hikes. The market is strictly closed on Sundays.
            </p>
          </div>
          ...
          <div className="bg-dark-card border border-forest-green/30 rounded-lg p-4">
            ...
            <div className="text-cream font-medium text-base">Vienna City Hotel</div>
