      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-4">
          ...
          <p className="text-cream-muted text-base leading-relaxed">
            ...
            Hallstatt at dawn. The Schafbergbahn cog railway in the afternoon.
          </p>
          ...
          <div className="bg-dark-card border border-amber/20 rounded-lg p-4">
            <div className="text-sm text-amber tracking-widest uppercase mb-2 font-medium">
              🚂 Schafbergbahn — Sample reservation
            </div>
            <p className="text-cream-muted text-base leading-relaxed">
              The demo marks this as reserved. For a real trip, use the ticket&apos;s ascent and return times. Sit on
              the <strong className="text-cream">right side</strong> of the train for the best lake views on the ascent,
              weather and seat availability permitting.
            </p>
          </div>

          <div className="bg-dark-card border border-amber/20 rounded-lg p-4">
            <div className="text-sm text-amber tracking-widest uppercase mb-2 font-medium">⏰ Hallstatt Timing</div>
            <p className="text-cream-muted text-base leading-relaxed">
              Arrive by <strong className="text-cream">7:30 AM</strong> for parking and the old town, then verify the
              funicular&apos;s current first-ascent time. The rest of this timing is fictional sample data and must be
              checked against official operating information.
            </p>
          </div>
        </div>
      </div>
